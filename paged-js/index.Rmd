...
What DOI regulations cause the most friction for prospective customers?
What kinds of policy transactions are customers unable to complete themselves?
How will upcoming rate activity affect customer loyalty,
and what can we do about it?
Explored data, recommended metrics, wrote ETL jobs, designed dashboards,
and offered learnings.

_Experiment Consultation_.
Consulted with stakeholders on experimentation,
from design through data collection to interpretation and action.
